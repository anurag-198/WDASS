...
def denorm_(img, mean, std):
    #img.mul_(std).add_(mean).div_(255.0)  #### 0-1
    img.mul_(std).add_(mean)  #### 0-1

def renorm_(img, mean, std):
    #img.mul_(255.0).sub_(mean).div_(std) #### on image scale and then again norm, -3,3
    img.sub_(mean).div_(std) #### on image scale and then again norm, -3,3
