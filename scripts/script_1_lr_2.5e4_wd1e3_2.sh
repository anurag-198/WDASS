...
python train.py --dataset cityscapes --crop_size 512,512 --bs_trn 4 --poly_exp 0.9 --lr 2.5e-4 --weight_decay 0.001 --max_iter 150000 --cv 0 --arch deepv2.DeepV2R101 --result_dir logs/coarse_ours_lr2.5e4_wd1e3_2 --coarse_sample 2975 --fine_sample 25000 --multiprocessing_distributed --edge_wt 10 --use_contrast --contrast_wt 1.0  --bn_buffer --weak_label coarse --resume /BS/WDA/work/data/pretrained/gta.pth --use_wl --imloss --improto